...
walkers = np.random.randn(65536, 32, 3).astype(np.float32)
...
while not tf.window_should_close():
    ...
    tf.imgui_plotlines("Random", random, overlay_text="Random plot", scale_min=-10.0, scale_max=10.0, graph_size=(0, 200))
