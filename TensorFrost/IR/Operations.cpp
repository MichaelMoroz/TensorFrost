...
const vector<Operation> operations = {
    ...
    //Algorithms
    //Reduction
    Operation("dim_sum", {"f_f", "u_u", "i_i"}, 0, "", {OpClass::Static, OpClass::Algorithm}), // sum of the last dimension
    Operation("dim_norm", {"f_f", "u_u", "i_i"}, 0, "", {OpClass::Static, OpClass::Algorithm}), // length(norm) of the last dimension
    Operation("dim_max", {"f_f", "u_u", "i_i"}, 0, "", {OpClass::Static, OpClass::Algorithm}), // max of the last dimension
    Operation("dim_min", {"f_f", "u_u", "i_i"}, 0, "", {OpClass::Static, OpClass::Algorithm}), // min of the last dimension
    Operation("dim_mean", {"f_f", "u_u", "i_i"}, 0, "", {OpClass::Static, OpClass::Algorithm}), // mean of the last dimension
    Operation("dim_prod", {"f_f", "u_u", "i_i"}, 0, "", {OpClass::Static, OpClass::Algorithm}), // product of the last dimension
    Operation("dim_any", {"u_u", "i_i", "b_b"}, 0, "", {OpClass::Static, OpClass::Algorithm}), // any of the last dimension
    Operation("dim_all", {"u_u", "i_i", "b_b"}, 0, "", {OpClass::Static, OpClass::Algorithm}), // all of the last dimension
    //Matrix
    Operation("transpose", {"f_f", "u_u", "i_i"}, 0, "", {OpClass::Static, OpClass::Algorithm}),
    Operation("dot", {"ff_f"}, 0, "", {OpClass::Static, OpClass::Algorithm}), // dot product of the last dimensions
    Operation("matmul", {"ff_f"}, 0, "", {OpClass::Static, OpClass::Algorithm}), // matrix multiplication of the last dimensions
    Operation("unsqueeze", {"f_f", "u_u", "i_i"}, 0, "", {OpClass::Static, OpClass::Algorithm}),
    Operation("squeeze", {"f_f", "u_u", "i_i"}, 0, "", {OpClass::Static, OpClass::Algorithm}),
