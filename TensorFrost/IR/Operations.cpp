...
vector<pair<string, vector<Operation>>> operations = {
    ...
    {"memory",
     {Operation("load", {{Types({dtype(memory_ref), dtype(u32)}), dtype(f32)},
                         {Types({dtype(memory_ref), dtype(u32)}), dtype(u32)},
                         {Types({dtype(memory_ref), dtype(u32)}), dtype(i32)}}),
      Operation(
          "store",
          {{Types({dtype(memory_ref), dtype(u32), dtype(u32)}), dtype(none)},
           {Types({dtype(memory_ref), dtype(u32), dtype(u32)}), dtype(none)},
           {Types({dtype(memory_ref), dtype(u32), dtype(u32)}), dtype(none)}}),
    ...
    {"atomic",
     {Operation(
          "InterlockedAdd",
          {{Types({dtype(memory_ref), dtype(u32), dtype(u32)}), dtype(none)},
           {Types({dtype(memory_ref), dtype(i32), dtype(u32)}), dtype(none)},
           {Types({dtype(memory_ref), dtype(f32), dtype(u32)}), dtype(none)}}),
      Operation(
          "InterlockedMin",
          {{Types({dtype(memory_ref), dtype(u32), dtype(u32)}), dtype(none)},
           {Types({dtype(memory_ref), dtype(i32), dtype(u32)}), dtype(none)},
