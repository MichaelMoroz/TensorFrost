...
vector<Operation> operations = {
    ...
    Operation("and", {"uu_u", "ii_i"}, 1, "&", OpType::Operator),
    Operation("or", {"uu_u", "ii_i"}, 1, "|", OpType::Operator),
    Operation("xor", {"uu_u", "ii_i"}, 1, "^", OpType::Operator),
    ...
    Operation("exp", {"f_f"}, 4),
    Operation("exp2", {"f_f"}, 2),
    Operation("log", {"f_f"}, 4),
    Operation("log2", {"f_f"}, 2),
    ...
    Operation("thread_count", {"_i", "_u"}, 1),
