...
class OpenGLMemoryManager : public TensorMemoryManager {
 public:
	...
	//}
	//
	//TensorMemory* AllocateWithData(
	//    const vector<int>& shape, const vector<uint>& data,
	//    const DataType type = DataType::Float) override {
	...
	//}
	//
	//void WritebackValue(const TensorMemory* mem, uint index,
	//                    uint value) override {
	...
	//}
	//
	//void Free(uint offset) override { Free(allocated_by_offset[offset]); }
	//
